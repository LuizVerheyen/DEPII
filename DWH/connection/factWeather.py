...
from data_gathering.email_fietsvergoeding.filler import fillFactStaffCommute
...
def pipeline():
    try:
        ...
        loadIN(engine=engine, df=fillFactStaffCommute(), table='FactStaffCommute')
        
        
        
    except Exception as e:
        logger.exception("Fout in FactMeteo pipeline")
